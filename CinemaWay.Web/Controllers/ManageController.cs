namespace CinemaWay.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            var emailIsChanged = model.Email != user.Email;
            if (emailIsChanged)
            {
            ...
            var phoneIsChanged = model.Phone != user.Phone;
            if (phoneIsChanged)
            {
            ...
            if (emailIsChanged || phoneIsChanged || firstNameIsChanged || lastNameIsChanged)
            {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("CinemaWay.Web"),
